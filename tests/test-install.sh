...
COPILOT_TOKEN="plain-secret-value"
GH_TOKEN='another-secret-value'
EOF
...
assert_output_not_contains "$SANITIZED_CONTENT" "plain-secret-value"
assert_output_not_contains "$SANITIZED_CONTENT" "another-secret-value"
echo ""
