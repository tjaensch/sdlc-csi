...
# ── Test 2e: Force re-install can clear configured rulesets ───────────────
echo "Test 2e: Re-install with --force clears rulesets when requested"

bash "$SCRIPT_DIR/install.sh" --repo-path "$REPO1" --rulesets "" --force
