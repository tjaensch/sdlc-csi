...
COPILOT_TOKEN: "super-secret-value-123456"
GH_TOKEN='another-secret-value-123456'
EOF
...
assert_output_not_contains "$SANITIZED_CONTENT" "super-secret-value-123456"
assert_output_not_contains "$SANITIZED_CONTENT" "another-secret-value-123456"
echo ""
